		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Consulta de mareas",
									"targetURL": "#Consultademareas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Consultademareas-display": {
								"semanticObject": "Consultademareas",
								"action": "display",
								"description": "Reporte de pesca: Consulta de mareas",
								"title": "Consulta de mareas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.consultamareas",
									"url": sap.ui.require.toUrl("com/tasa/consultamareas")
								}
							}
						}
					}
