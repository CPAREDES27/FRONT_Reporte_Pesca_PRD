		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reporte TDC CHD",
									"targetURL": "#ReporteTDCCHD-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ReporteTDCCHD-display": {
								"semanticObject": "ReporteTDCCHD",
								"action": "display",
								"description": "Reporte de pesca: Reporte TDC CHD",
								"title": "Reporte TDC CHD",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.reportetdcchd",
									"url": sap.ui.require.toUrl("com/tasa/reportetdcchd")
								}
							}
						}
					}
