		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reporte de calas",
									"targetURL": "#Reportedecalas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Reportedecalas-display": {
								"semanticObject": "Reportedecalas",
								"action": "display",
								"description": "Reporte de pesca: Reporte de calas",
								"title": "Reporte de calas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.reportecala",
									"url": sap.ui.require.toUrl("com/tasa/reportecala")
								}
							}
						}
					}
