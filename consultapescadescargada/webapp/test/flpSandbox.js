		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Consulta de pesca descargada",
									"targetURL": "#Consultadepescadescargada-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Consultadepescadescargada-display": {
								"semanticObject": "Consultadepescadescargada",
								"action": "display",
								"description": "Reporte de pesca: Consulta de pesca descargada",
								"title": "Consulta de pesca descargada",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.consultapescadescargada",
									"url": sap.ui.require.toUrl("com/tasa/consultapescadescargada")
								}
							}
						}
					}
